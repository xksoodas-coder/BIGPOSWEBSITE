...
// `const BWS` تعريف معجمي: يُرى في كل السكربتات لكنه لا يظهر على `window`.
// نُعلّقه صراحةً كي تعمل الفحوص الدفاعية من نوع `window.BWS?.…` (وللتشخيص من
// وحدة تحكّم المتصفح) بدل أن تُرجِع undefined وتعطّل ما يعتمد عليها.
window.BWS = BWS;
